        ...
        if (mysqli_connect_errno()){
            ...
            if(isset($_POST['send'])){
                ...
                $send_query="INSERT INTO `messages` (`thread_id`, `text`, `sender_type`, `timestamp`) 
                                           VALUES ('$thread_id', '$text', 'Technician', CURRENT_TIMESTAMP())";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-3">
                    <div class="btn btn-light mt-2 mb-2 d-flex justify-content-center container-fluid">
                    ...
                    <div class="d-flex flex-column justify-content-center container-fluid">
                        <h4 class="text-bg-success d-flex justify-content-center p-3">Customers</h4>
                        <?php 
                            $threads_query="SELECT *,(SELECT `name` FROM `register_customer` WHERE `id`=`customer_id`) as 'name'
                                             FROM `threads` WHERE `technician_id`='$_SESSION[uid]'";
                            $run_threads_query=mysqli_query($con, $threads_query);
                            while($threads_data=mysqli_fetch_array($run_threads_query)){
                        ?>
                            <a href="customer_messeges.php?thread_id=<?php echo $threads_data['id'];?>&customer_name=<?php echo $threads_data['name'];?>" class="btn btn btn-light mb-2">
                ...
                <div class="col-9 bg-transparent">
                    ...
                    ?>
                                <div class="row container-fluid p-2">
                                    <div class="col-12">
                                        <div class="d-flex flex-column <?php echo ($messege_data['sender_type']=="Technician")?"align-items-end":"align-items-start";?> p-2">
                                            <div class="text-bg-secondary rounded d-flex justify-content-center p-1" style="max-width: 9rem;">
                                                <?php echo ($messege_data['sender_type']=="Technician")?"You": $c_name ; ?>
                                            </div>
